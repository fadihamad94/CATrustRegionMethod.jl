...
function generateALLResultsCSVFile(directoryName::String, df_results_CAT_I_FACTORIZATION::DataFrame, df_results_CAT_II_FACTORIZATION::DataFrame, df_results_CAT_II_THETA_ZERO_FACTORIZATION::DataFrame, df_results_ARC_FACTORIZATION_OPTIMIZATION::DataFrame, df_results_TRUST_REGION_OPTIMIZATION::DataFrame)
    results = DataFrame(PROBLEM_NAME = [], CAT_I_FACTORIZATION_F = [], CAT_I_FACTORIZATION_G = [], CAT_I_FACTORIZATION_H = [],CAT_I_FACTORIZATION_FCT = [], CAT_II_FACTORIZATION_F = [], CAT_II_FACTORIZATION_G = [], CAT_II_FACTORIZATION_H = [], CAT_II_FACTORIZATION_FCT = [],
     CAT_II_THETA_ZERO_FACTORIZATION_F = [], CAT_II_THETA_ZERO_FACTORIZATION_G = [], CAT_II_THETA_ZERO_FACTORIZATION_H = [], CAT_II_THETA_ZERO_FACTORIZATION_FCT = [], ARC_FACTORIZATION_F = [], ARC_FACTORIZATION_G = [], ARC_FACTORIZATION_H = [],
    ARC_FACTORIZATION_FCT = [], TRU_FACTORIZATION_F = [], TRU_FACTORIZATION_G = [], TRU_FACTORIZATION_H = [], TRU_FACTORIZATION_FCT = [])
...
function collectAllResults(directoryName::String)
    ...
    df_results_CAT_I_FACTORIZATION_ALL = df_results_CAT_I_FACTORIZATION[:, filter(x -> (x in [PROBLEM_NAME_COLUMN, TOTAL_FUNCTION_EVALUATION_COLUMN, TOTAL_GRADIENT_EVALUATION_COLUMN, TOTAL_HESSIAN_EVALUATION_COLUMN, TOTAL_FACTORIZATION_EVALUATION_COLUMN]), names(df_results_CAT_I_FACTORIZATION))]
    df_results_CAT_II_FACTORIZATION_ALL = df_results_CAT_II_FACTORIZATION[:, filter(x -> (x in [TOTAL_FUNCTION_EVALUATION_COLUMN, TOTAL_GRADIENT_EVALUATION_COLUMN, TOTAL_HESSIAN_EVALUATION_COLUMN, TOTAL_FACTORIZATION_EVALUATION_COLUMN]), names(df_results_CAT_II_FACTORIZATION))]
    df_results_CAT_II_THETA_ZERO_FACTORIZATION_ALL = df_results_CAT_II_THETA_ZERO_FACTORIZATION[:, filter(x -> (x in [TOTAL_FUNCTION_EVALUATION_COLUMN, TOTAL_GRADIENT_EVALUATION_COLUMN, TOTAL_HESSIAN_EVALUATION_COLUMN, TOTAL_FACTORIZATION_EVALUATION_COLUMN]), names(df_results_CAT_II_THETA_ZERO_FACTORIZATION))]
    df_results_ARC_FACTORIZATION_OPTIMIZATION_ALL = df_results_ARC_FACTORIZATION_OPTIMIZATION[:, filter(x -> (x in [TOTAL_FUNCTION_EVALUATION_COLUMN, TOTAL_GRADIENT_EVALUATION_COLUMN, TOTAL_HESSIAN_EVALUATION_COLUMN, TOTAL_FACTORIZATION_EVALUATION_COLUMN]), names(df_results_ARC_FACTORIZATION_OPTIMIZATION))]
    df_results_TRUST_REGION_OPTIMIZATION_ALL = df_results_TRUST_REGION_OPTIMIZATION[:, filter(x -> (x in [TOTAL_FUNCTION_EVALUATION_COLUMN, TOTAL_GRADIENT_EVALUATION_COLUMN, TOTAL_HESSIAN_EVALUATION_COLUMN, TOTAL_FACTORIZATION_EVALUATION_COLUMN]), names(df_results_TRUST_REGION_OPTIMIZATION))]
