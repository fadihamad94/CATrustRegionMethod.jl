...
function computeFraction(df::DataFrame, TOTAL::Vector{Int64}, criteria::String)
    ...
    if criteria == "Functions"
        results_fraction = DataFrame(Functions=Int[], CAT_I_FACTORIZATION=Float64[], CAT_II_FACTORIZATION=Float64[], CAT_II_THETA_ZERO_FACTORIZATION=Float64[], ARC_FACTORIZATION=Float64[], TRU_FACTORIZATION=Float64[])
        results_total = DataFrame(Functions=Int[], CAT_I_FACTORIZATION=Int[], CAT_II_FACTORIZATION=Float64[], CAT_II_THETA_ZERO_FACTORIZATION=Int[], ARC_FACTORIZATION=Int[], TRU_FACTORIZATION=Int[])
...
function computeFraction_CAT(df::DataFrame, TOTAL::Vector{Int64}, criteria::String)
    ...
    if criteria == "Functions"
        results_fraction = DataFrame(Functions=Int[], CAT_II_FACTORIZATION=Float64[], CAT_II_THETA_ZERO_FACTORIZATION=Float64[])
        results_total = DataFrame(Functions=Int[], CAT_II_FACTORIZATION=Float64[], CAT_II_THETA_ZERO_FACTORIZATION=Float64[])
    elseif criteria == "Gradients"
...
function generateFiguresComparisonCAT(dirrectoryName::String)
    ...
    results = results[:, filter(x -> (x in ["Functions", CAT_II_FACTORIZATION,CAT_II_THETA_ZERO_FACTORIZATION]), names(results))]
...
function plotFiguresComparisonFinal(df::DataFrame, criteria::String, dirrectoryName::String, plot_name::String)
    data = Matrix(df[!, Not(criteria)])
    dict_ = Dict("Functions" => "function evaluations", "Gradients" => "gradient evaluations",
...
function generateFiguresIterationsComparisonFinal(dirrectoryName::String)
    ...
    results = results[:, filter(x -> (x in ["Functions", CAT_I_FACTORIZATION,CAT_II_FACTORIZATION,ARC_FACTORIZATION,TRU_FACTORIZATION]), names(results))]
